...
void main() {
	...
	`}var eo=class extends Vt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new gi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `})]})}function al(){let[e,t]=$c(.3);return(0,Y.jsx)(`section`,{ref:e,style:{minHeight:`80vh`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`6rem 2rem`,borderTop:`1px solid ${Jc}`},children:(0,Y.jsx)(`div`,{style:{maxWidth:850,textAlign:`center`,opacity:+!!t,transform:t?`translateY(0)`:`translateY(40px)`,transition:`all 1s cubic-bezier(0.16,1,0.3,1)`},children:(0,Y.jsxs)(`div`,{style:{fontFamily:Yc,fontSize:`clamp(1.5rem, 3.5vw, 2.75rem)`,fontWeight:700,lineHeight:1.35,color:Kc,letterSpacing:1},children:[`The tools that exist for business operations are designed for`,` `,(0,Y.jsx)(`span`,{style:{color:qc,textDecoration:`line-through`},children:`visibility`}),`.`,(0,Y.jsx)(`br`,{}),`Aletheos is designed for`,` `,(0,Y.jsx)(`span`,{style:{color:X,textShadow:`0 0 20px ${Bc}`},children:`truth`}),`.`]})})})}function ol(){let[e,t]=$c(.1);return(0,Y.jsxs)(`section`,{ref:e,style:{maxWidth:1100,margin:`0 auto`,padding:`4rem 2.5rem 6rem`},children:[(0,Y.jsx)(`div`,{style:{fontFamily:Xc,fontSize:10,letterSpacing:4,color:X,marginBottom:`1rem`,textAlign:`center`,opacity:+!!t,transition:`opacity 0.6s ease 0.2s`},children:`LIVE CONSOLE PREVIEW`}),(0,Y.jsx)(`h2`,{style:{fontFamily:Yc,fontSize:28,fontWeight:700,color:Kc,margin:`0 0 2.5rem`,textAlign:`center`,letterSpacing:1,opacity:+!!t,transition:`opacity 0.6s ease 0.4s`},children:`See everything. In real time.`}),(0,Y.jsx)(nl,{})]})}function sl(){return(0,Y.jsxs)(`section`,{style:{maxWidth:1100,margin:`0 auto`,padding:`4rem 2.5rem 6rem`,borderTop:`1px solid ${Jc}`},children:[(0,Y.jsx)(`div`,{style:{fontFamily:Xc,fontSize:10,letterSpacing:4,color:X,marginBottom:`3rem`,textAlign:`center`},children:`CORE CAPABILITIES`}),(0,Y.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:0},children:[{icon:`◆`,label:`STATE INTEGRITY`,title:`Cryptographic proof, not promises.`,desc:`Aletheos validates state integrity against cryptographic hashes. It detects stale data and labels it stale instead of presenting it as current. You see what's real — not what someone forgot to update.`,detail:`SHA-256 validation · Stale data detection · Hash chain verification · Tamper-evident logging`},{icon:`◈`,label:`RULE ENFORCEMENT`,title:`Hard gates, not suggestions.`,desc:`Business rules enforced at the system level. Not as suggestions. Not as warning dialogs. As hard gates that block unauthorized actions and log every attempt.`,detail:`Role-based enforcement · Action authorization · Attempt logging · Policy drift detection`},{icon:`◇`,label:`OPERATOR CONTROL`,title:`The truth, on any device.`,desc:`Real-time view of every active workstream with priority ranking, phase tracking, blocker visibility, and artifact binding — from a desk or from a phone.`,detail:`Desktop + mobile · Priority ranking · Phase tracking · Blocker alerts · Artifact binding`}].map((e,t)=>{let[n,r]=$c(.15),[i,a]=(0,l.useState)(!1);return(0,Y.jsxs)(`div`,{ref:n,onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),style:{display:`grid`,gridTemplateColumns:`80px 1fr`,gap:`2rem`,padding:`3rem 2rem`,borderBottom:`1px solid ${Jc}`,background:i?zc:`transparent`,opacity:+!!r,transform:r?`translateX(0)`:`translateX(-30px)`,transition:`all 0.7s cubic-bezier(0.16,1,0.3,1) ${t*.12}s, background 0.3s`,cursor:`default`},children:[(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`0.5rem`},children:[(0,Y.jsx)(`span`,{style:{fontSize:28,color:X,opacity:i?.8:.3,transition:`opacity 0.3s`},children:e.icon}),(0,Y.jsx)(`span`,{style:{fontFamily:Xc,fontSize:8,letterSpacing:2,color:X,opacity:i?1:.5,transition:`opacity 0.3s`},children:e.label})]}),(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(`h3`,{style:{fontFamily:Yc,fontSize:24,fontWeight:700,color:Kc,margin:`0 0 0.75rem`,letterSpacing:.5},children:e.title}),(0,Y.jsx)(`p`,{style:{fontFamily:Zc,fontSize:14,lineHeight:1.7,color:qc,margin:0,maxWidth:550},children:e.desc}),(0,Y.jsx)(`div`,{style:{marginTop:`1rem`,fontFamily:Xc,fontSize:10,color:X,letterSpacing:.5,lineHeight:1.8,maxHeight:i?40:0,overflow:`hidden`,opacity:i?.6:0,transition:`all 0.4s cubic-bezier(0.16,1,0.3,1)`},children:e.detail})]})]},t)})})]})}function cl(){let[e,t]=$c(.3);return(0,Y.jsx)(`section`,{ref:e,style:{padding:`6rem 2.5rem`,background:Gc,borderTop:`1px solid ${Jc}`,borderBottom:`1px solid ${Jc}`},children:(0,Y.jsxs)(`div`,{style:{maxWidth:900,margin:`0 auto`,textAlign:`center`,opacity:+!!t,transform:t?`scale(1)`:`scale(0.96)`,transition:`all 0.8s cubic-bezier(0.16,1,0.3,1)`},children:[(0,Y.jsx)(`div`,{style:{fontFamily:Xc,fontSize:10,letterSpacing:4,color:X,marginBottom:`2rem`},children:`MARKET POSITION`}),(0,Y.jsxs)(`div`,{style:{fontFamily:Yc,fontSize:`clamp(1.25rem, 2.5vw, 2rem)`,fontWeight:700,lineHeight:1.4,color:Kc,letterSpacing:.5},children:[`We are not competing with`,` `,(0,Y.jsx)(`span`,{style:{color:qc,opacity:.4},children:`Notion`}),`,`,` `,(0,Y.jsx)(`span`,{style:{color:qc,opacity:.4},children:`Monday`}),`, or`,` `,(0,Y.jsx)(`span`,{style:{color:qc,opacity:.4},children:`Jira`}),`.`]}),(0,Y.jsxs)(`div`,{style:{fontFamily:Yc,fontSize:`clamp(1.25rem, 2.5vw, 2rem)`,fontWeight:700,lineHeight:1.4,color:Kc,letterSpacing:.5,marginTop:`1rem`},children:[`We are building the`,` `,(0,Y.jsx)(`span`,{style:{color:X,textShadow:`0 0 15px ${Bc}`},children:`control plane`}),` `,`that sits above all of them.`]}),(0,Y.jsxs)(`div`,{style:{display:`flex`,justifyContent:`center`,gap:`3rem`,marginTop:`3rem`,fontFamily:Xc,fontSize:9,letterSpacing:2},children:[(0,Y.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,Y.jsx)(`div`,{style:{color:qc,marginBottom:`0.25rem`},children:`REPORTING`}),(0,Y.jsx)(`div`,{style:{color:qc,opacity:.4},children:`What happened`})]}),(0,Y.jsx)(`div`,{style:{color:X,fontSize:16,alignSelf:`center`},children:`→`}),(0,Y.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,Y.jsx)(`div`,{style:{color:X},children:`GOVERNANCE`}),(0,Y.jsx)(`div`,{style:{color:X,opacity:.6},children:`What happens next`})]})]})]})})}function ll(){let e=[{reporting:`Shows you charts`,governance:`Validates state integrity`},{reporting:`Displays colored statuses`,governance:`Detects if data is stale`},{reporting:`Trusts manual entry`,governance:`Enforces cryptographic proof`},{reporting:`Suggests best practices`,governance:`Blocks unauthorized actions`},{reporting:`Generates after-the-fact reports`,governance:`Surfaces truth in real time`}],[t,n]=$c(.15);return(0,Y.jsx)(`section`,{ref:t,style:{maxWidth:1100,margin:`0 auto`,padding:`6rem 2.5rem`},children:(0,Y.jsxs)(`div`,{style:{opacity:+!!n,transform:n?`translateY(0)`:`translateY(25px)`,transition:`all 0.8s cubic-bezier(0.16,1,0.3,1)`},children:[(0,Y.jsx)(`div`,{style:{fontFamily:Xc,fontSize:10,letterSpacing:4,color:X,marginBottom:`1rem`,textAlign:`center`},children:`THE DIFFERENCE`}),(0,Y.jsx)(`h2`,{style:{fontFamily:Yc,fontSize:28,fontWeight:700,color:Kc,margin:`0 0 3rem`,textAlign:`center`,letterSpacing:1},children:`Reporting tells you. Governance ensures.`}),(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:0},children:[(0,Y.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 60px 1fr`,padding:`0.75rem 0`,marginBottom:`0.5rem`},children:[(0,Y.jsx)(`span`,{style:{fontFamily:Xc,fontSize:9,color:qc,letterSpacing:2,textAlign:`center`},children:`REPORTING TOOLS`}),(0,Y.jsx)(`span`,{}),(0,Y.jsx)(`span`,{style:{fontFamily:Xc,fontSize:9,color:X,letterSpacing:2,textAlign:`center`},children:`ALETHEOS`})]}),e.map((e,t)=>(0,Y.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 60px 1fr`,padding:`1rem 1.5rem`,borderTop:`1px solid ${Jc}`,alignItems:`center`},children:[(0,Y.jsx)(`span`,{style:{fontFamily:Zc,fontSize:14,color:qc,textAlign:`center`,textDecoration:`line-through`,opacity:.5},children:e.reporting}),(0,Y.jsx)(`div`,{style:{textAlign:`center`},children:(0,Y.jsxs)(`svg`,{width:`24`,height:`12`,viewBox:`0 0 24 12`,children:[(0,Y.jsx)(`line`,{x1:`0`,y1:`6`,x2:`20`,y2:`6`,stroke:X,strokeWidth:`1`}),(0,Y.jsx)(`polyline`,{points:`16,2 22,6 16,10`,fill:`none`,stroke:X,strokeWidth:`1`})]})}),(0,Y.jsx)(`span`,{style:{fontFamily:Zc,fontSize:14,color:X,textAlign:`center`,fontWeight:600},children:e.governance})]},t))]})]})})}function ul(){let[e,t]=(0,l.useState)({name:``,email:``,company:``,message:``}),[n,r]=(0,l.useState)(null),[i,a]=$c(.15),o=e=>({width:`100%`,padding:`0.875rem 1rem`,fontFamily:Zc,fontSize:14,background:Wc,border:`1px solid ${n===e?X:Jc}`,color:Kc,outline:`none`,transition:`all 0.2s`,boxSizing:`border-box`,boxShadow:n===e?`0 0 0 2px ${zc}`:`none`});return(0,Y.jsx)(`section`,{id:`contact`,ref:i,style:{maxWidth:1100,margin:`0 auto`,padding:`6rem 2.5rem 8rem`,borderTop:`1px solid ${Jc}`},children:(0,Y.jsx)(`div`,{style:{opacity:+!!a,transform:a?`translateY(0)`:`translateY(25px)`,transition:`all 0.8s cubic-bezier(0.16,1,0.3,1)`},children:(0,Y.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`5rem`},children:[(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(`div`,{style:{fontFamily:Xc,fontSize:10,letterSpacing:4,color:X,marginBottom:`1.5rem`},children:`REQUEST ACCESS`}),(0,Y.jsx)(`h2`,{style:{fontFamily:Yc,fontSize:32,fontWeight:700,color:Kc,margin:`0 0 1rem`,letterSpacing:1},children:`Ready to see the truth?`}),(0,Y.jsx)(`p`,{style:{fontFamily:Zc,fontSize:14,color:qc,lineHeight:1.7},children:`Aletheos is built for operators who run complex, multi-entity, high-accountability operations. If that's you — request access.`}),(0,Y.jsxs)(`div`,{style:{marginTop:`2rem`,padding:`1.5rem`,background:Wc,border:`1px solid ${Jc}`},children:[(0,Y.jsx)(`div`,{style:{fontFamily:Xc,fontSize:9,letterSpacing:2,color:X,marginBottom:`1rem`},children:`PLATFORM INCLUDES`}),[`Real-time state validation`,`Cryptographic audit trails`,`Multi-entity governance`,`Desktop + mobile control`,`Rule enforcement engine`].map((e,t)=>(0,Y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.5rem`,padding:`0.35rem 0`},children:[(0,Y.jsx)(el,{color:Vc,size:4}),(0,Y.jsx)(`span`,{style:{fontFamily:Xc,fontSize:11,color:qc},children:e})]},t))]})]}),(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`0.875rem`},children:[(0,Y.jsx)(`input`,{placeholder:`Name`,value:e.name,onChange:n=>t({...e,name:n.target.value}),onFocus:()=>r(`name`),onBlur:()=>r(null),style:o(`name`)}),(0,Y.jsx)(`input`,{placeholder:`Email`,value:e.email,onChange:n=>t({...e,email:n.target.value}),onFocus:()=>r(`email`),onBlur:()=>r(null),style:o(`email`)}),(0,Y.jsx)(`input`,{placeholder:`Company`,value:e.company,onChange:n=>t({...e,company:n.target.value}),onFocus:()=>r(`company`),onBlur:()=>r(null),style:o(`company`)}),(0,Y.jsx)(`textarea`,{placeholder:`Tell us about your operations`,rows:5,value:e.message,onChange:n=>t({...e,message:n.target.value}),onFocus:()=>r(`message`),onBlur:()=>r(null),style:{...o(`message`),resize:`vertical`}}),(0,Y.jsx)(`button`,{style:{padding:`0.8rem 2.5rem`,background:X,border:`none`,color:Uc,fontFamily:Zc,fontSize:14,fontWeight:700,cursor:`pointer`,transition:`all 0.3s cubic-bezier(0.16,1,0.3,1)`,letterSpacing:.5},onMouseEnter:e=>{e.target.style.boxShadow=`0 0 30px ${Bc}`,e.target.style.transform=`translateY(-2px)`},onMouseLeave:e=>{e.target.style.boxShadow=`none`,e.target.style.transform=`translateY(0)`},children:`Request Access`})]})]})})})}function dl(){return(0,Y.jsxs)(`footer`,{style:{maxWidth:1100,margin:`0 auto`,padding:`2rem 2.5rem`,borderTop:`1px solid ${Jc}`,display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,Y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.75rem`},children:[(0,Y.jsx)(`div`,{style:{width:16,height:16,border:`1px solid ${X}`,borderRadius:`50%`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,Y.jsx)(`div`,{style:{width:4,height:4,background:X,borderRadius:`50%`}})}),(0,Y.jsxs)(`span`,{style:{fontFamily:Zc,fontSize:12,color:qc},children:[`© `,new Date().getFullYear(),` Aletheos · Built by M20R1`]})]}),(0,Y.jsx)(`span`,{style:{fontFamily:Xc,fontSize:9,color:qc,letterSpacing:2},children:`A NOVE MANI PRODUCT`})]})}function fl(){return(0,Y.jsxs)(`div`,{style:{background:Uc,color:Kc,minHeight:`100vh`},children:[(0,Y.jsx)(`link`,{href:`https://fonts.googleapis.com/css2?family=Rajdhani:wght@400;500;600;700&family=Share+Tech+Mono&family=Exo+2:wght@400;500;600;700&display=swap`,rel:`stylesheet`}),(0,Y.jsx)(rl,{}),(0,Y.jsx)(il,{}),(0,Y.jsx)(al,{}),(0,Y.jsx)(ol,{}),(0,Y.jsx)(sl,{}),(0,Y.jsx)(cl,{}),(0,Y.jsx)(ll,{}),(0,Y.jsx)(ul,{}),(0,Y.jsx)(dl,{})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,Y.jsx)(l.StrictMode,{children:(0,Y.jsx)(fl,{})}));